...
public abstract class BaseController {
    ...
    public ResponseWrapper handleDataException(DataException e) {
        ...
        return new ResponseWrapper(CommonConstants.FAIL, getResponseMessage(e.getMessage(), e.getData()));
    }

    @ExceptionHandler(Exception.class)
    public ResponseWrapper handleOtherException(Exception e) {
        LOG.debug("Other exception caught!", e);
        return new ResponseWrapper(CommonConstants.ERROR, getResponseMessage("error.ServerError"));
    }
